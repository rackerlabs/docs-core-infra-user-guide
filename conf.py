...
extlinks = {
    ...
    'rax-docs': ('https://developer.rackspace.com/docs/%s', ''),
    ...
    'rax-api': ('https:/developer.rackspace.com/docs/%s/#api-reference', ''),
...
# html_title = 'Rackspace Cloud Core Infrastructure Guide'
...
htmlhelp_basename = 'RackspaceCloudCoreInfrastructureServicesUserGuidedoc'
...
latex_documents = [
  ('index', 'RackspaceCloudCoreInfrastructureServicesUserGuide.tex', u'Rackspace Cloud Core Infrastructure Services User Guide Documentation',
   u'Rackspace', 'manual'),
]
