...
Rename
------
The rename action changes the label for how a server is named in
the Cloud Control Panel and via the API. This does not actually
change the hostname on the server itself.
